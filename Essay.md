...
Luckily, software and research contributions by women bitcoiners—which is easier to quantify—are also increasing over time. For example, Neha Narula, Amiti Uttarwar and Gloria Zhao have contributed to the Bitcoin reference implementation, Bitcoin Core. Alyssa Hertig and Carla Kirk-Cohen have contributed to the lnd implementation of the Lightning Network scaling solution for Bitcoin whilst Lisa Neigut and Valentine Wallace have contributed to the c-lightning and rust-lightning implementations respectively.
